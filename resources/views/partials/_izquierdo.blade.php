    ...
    <div class="row">
        <div class="col-md-4">
            <ul class="menu left-menu clearfix">
                ...
                <li class="megamenu-container"><a href="#">Operaciones</a>
                    <div class="megamenu">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2">
                                    <a href="#" class="megamenu-title">Ciudadano</a>
                                    <ul>
                                        <li><a href="#">Denuncias</a></li>
                                        <li><a href="#">Consulta Multas</a></li>
                                        <li><a href="#">Pago en Linea</a></li>
                                    </ul>
                                </div><!-- End .col-md-2 -->
                                <div class="col-md-2">
                                    <a href="#" class="megamenu-title">Dirigente</a>
                                    <ul>
                                        <li><a href="#">Confirmacion</a></li>
                                        <li><a href="#">Consulta Multas</a></li>
                                        <li><a href="#">Registro de obras</a></li>
                                        <li><a href="#">Registros Contables</a></li>
                                        <li><a href="#">Estado de Obras</a></li>
                                    </ul>
                                </div><!-- End .col-md-2 -->
                                <div class="col-md-2">
                                    <a href="#" class="megamenu-title">Proveedor</a>
                                    <ul>
                                        <li><a href="#">Registro</a></li>
                                        <li><a href="#">Consulta Obras</a></li>
                                        <li><a href="">Cotizaciones</a></li>
                                        <li><a href="#">Estado de Pagos</a></li>
                                    </ul>
                                </div><!-- End .col-md-2 -->
                                <div class="col-md-2">
                                    <a href="#" class="megamenu-title">DMQ</a>
                                    <ul>
                                        <li><a href="">Dashboard</a></li>
                                        <li><a href="#">Consulta Barrios</a></li>
                                    </ul>
                                </div><!-- End .col-md-2 -->

                                <div class="col-md-4 menu-banner">
                                    <a href="#" class="banner text-left">
                                        <img src="{{ asset('images/limpieza1.jpg') }}" alt="Banner">
