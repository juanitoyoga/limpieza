...
@section('page-description', 'Consulta de los datos del Barrio')
            ...
            <div class="p-6 md:p-8">
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Esta es la informacion registrada en la aplicacion LimpiaTuRincon
                    </p>
                </div>

                <form action="{{ route('barrios.index') }}" method="get" class="space-y-6">
