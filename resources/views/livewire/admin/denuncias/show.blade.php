                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            @if(strtolower($denuncia->estado) == 'aprobado' || strtolower($denuncia->estado) == 'resuelto')
                            <div class="p-4 bg-green-50 dark:bg-green-950/20 rounded-xl border border-green-100 dark:border-green-900/40">
                                ...
                                <div class="mt-3 pt-2.5 border-t border-green-200 dark:border-green-900/60 flex justify-between text-sm items-center">
                                    ...
                                    <span class="font-bold text-green-700 dark:text-green-400 text-base">Bs. {{ number_format($denuncia->multa_calculada, 2) }}</span>
                                </div>
                                @endif
                            </div>

                            @elseif(strtolower($denuncia->estado) == 'rechazado')
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 rounded-xl text-center font-bold text-lg border shadow-sm
                            @if(strtolower($denuncia->estado) == 'aprobado' || strtolower($denuncia->estado) == 'resuelto') bg-green-100 text-green-800 border-green-300 dark:bg-green-900/40 dark:text-green-300 dark:border-green-800
                            @elif(strtolower($denuncia->estado) == 'rechazado') bg-red-100 text-red-800 border-red-300 dark:bg-red-900/40 dark:text-red-300 dark:border-red-800
                            ...
                            {{-- Icono según estado --}}
                            <x-heroicon-s-{{ 
                                strtolower($denuncia->estado) === 'aprobado' || strtolower($denuncia->estado) === 'resuelto'
                                    ? 'check-badge'
                                    : (strtolower($denuncia->estado) === 'rechazado'
                                        ? 'x-circle'
                                        : 'clock')
                            }} class="w-5 h-5 mr-2" />
                        ...
                        <div class="mt-4 space-y-2">
                            @if(strtolower($denuncia->estado) == 'pendiente')
                            ...
                            @if(in_array(strtolower($denuncia->estado), ['verificado', 'pendiente']))
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 border border-gray-100 dark:border-gray-700/60 mb-5 space-y-2.5">
                    ...
                    <div class="pt-2 border-t border-dashed border-gray-200 dark:border-gray-700 flex justify-between items-center">
                        ...
                        <span class="text-lg font-black text-green-600 dark:text-green-400 font-mono">
                            Bs. {{ number_format($multa_calculada, 2) }}
                        </span>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-center">
                        <div class="p-2 bg-blue-50/50 dark:bg-blue-950/10 rounded-lg border border-blue-100/60 dark:border-blue-900/30">
                            ...
                            <span class="text-xs font-bold font-mono text-blue-700 dark:text-blue-300">Bs. {{ number_format($multa_calculada * 0.4, 1) }}</span>
                        </div>
                        <div class="p-2 bg-purple-50/50 dark:bg-purple-950/10 rounded-lg border border-purple-100/60 dark:border-purple-900/30">
                            ...
                            <span class="text-xs font-bold font-mono text-purple-700 dark:text-purple-300">Bs. {{ number_format($multa_calculada * 0.4, 1) }}</span>
                        </div>
                        <div class="p-2 bg-amber-50/50 dark:bg-amber-950/10 rounded-lg border border-amber-100/60 dark:border-amber-900/30">
                            ...
                            <span class="text-xs font-bold font-mono text-amber-700 dark:text-amber-300">Bs. {{ number_format($multa_calculada * 0.2, 1) }}</span>
                        </div>
                    </div>
                </div>
