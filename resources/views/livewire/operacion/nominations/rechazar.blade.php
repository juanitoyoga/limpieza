@section('page-title', 'Rechazar Nominación')
@section('page-description', 'Rechazo formal de la nominación')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200 dark:divide-gray-700">
            ...
            <div class="p-6 md:p-8">
                ...
                <form wire:submit.prevent="save" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-2">Observaciones sobre la anulacion *</label>
