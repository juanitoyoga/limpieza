@section('page-title', 'Rescindir Contrato')
@section('page-description', 'Rescisión del contrato de servicio')
...
<div class="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200 max-w-xl mx-auto">
    <h2 class="text-lg font-semibold text-gray-800 mb-4">
        <i class="fas fa-times-circle mr-2 text-red-500"></i> Rescindir Contrato {{ $contrato->codigo }}
    </h2>
    ...
    <form wire:submit.prevent="save" class="space-y-6">
        <div>
            <label class="block text-sm font-semibold mb-2">Motivo de la rescisión *</label>
            <textarea wire:model="observaciones" rows="4"
                placeholder="Explique por qué se rescinde este contrato..."
        ...
        <div class="flex justify-center gap-4">
            <button type="submit" wire:loading.attr="disabled"
                ...
                <i class="fas fa-times-circle mr-2"></i> RESCINDIR
            </button>
