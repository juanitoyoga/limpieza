@section('page-title', 'Verificar Contrato')
@section('page-description', 'Verificación del contrato de servicio')
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div class="flex items-start space-x-3">
                        ...
                        <label for="check-resp" class="text-sm text-yellow-900 cursor-pointer">
                            <strong>Declaración Jurada:</strong> Como Presidente barrial, declaro que he verificado la información de este contrato y asumo la responsabilidad de este acto.
                        </label>
                    </div>
                ...
                <div class="pt-4 flex justify-center space-x-4">
                    <button type="submit" wire:loading.attr="disabled"
                        ...
                        <span wire:loading.remove class="flex items-center"><i class="fas fa-shield-check mr-2"></i> VERIFICAR</span>
            ...
            <div class="p-6 md:p-8 bg-gray-50 flex flex-col justify-center">
                <div class="max-w-xs mx-auto text-center">
                    ...
                    <ul class="text-left space-y-4 text-sm text-gray-600">
                        ...
                        <li class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-3"></i>
                            <span>Tras la aprobación, el contrato pasará a espera de aprobación del Presidente barrial.</span>
                        </li>
                    </ul>
                </div>
            </div>
