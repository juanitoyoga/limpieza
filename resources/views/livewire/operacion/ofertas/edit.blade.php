...
<x-app-layout>
    <div class="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Editar Oferta {{ $oferta->codigo }}</h1>
        </div>
        ...
        <form action="{{ route('ofertas.update', $oferta) }}" method="POST">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 shadow">Actualizar Oferta</button>
            </div>
        </form>
    </div>
</x-app-layout>